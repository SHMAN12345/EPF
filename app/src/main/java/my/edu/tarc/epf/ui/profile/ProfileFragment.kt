...
class ProfileFragment : Fragment(), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val name=sharePref.getString(getString(R.string.name),getString((R.string.nav_header_title)))
        val email=sharePref.getString(getString(R.string.email),getString((R.string.nav_header_subtitle)))
